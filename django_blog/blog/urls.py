...
from .views import UserLoginView, UserLogoutView, RegisterView, ProfileView, HomeView, create_post, PostListView, PostDeleteView, PostUpdateView, PostDetailView
